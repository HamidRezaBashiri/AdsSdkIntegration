 ...
 */
public class MyGamBannerEventHandler implements BannerEventHandler, MyGamAdEventListener {

    private static final String TAG = MyGamBannerEventHandler.class.getSimpleName();
    ...
    private MyPublisherAdViewWrapper requestBanner;
    private MyPublisherAdViewWrapper proxyBanner;
    private MyPublisherAdViewWrapper embeddedBanner;
    private MyPublisherAdViewWrapper recycledBanner;
     ...
     */
    public MyGamBannerEventHandler(
            Context context,
            String gamAdUnitId,
            AdSize... adSizes
    ) {
    ...
    @Override
    public void onEvent(MyAdEvent adEvent) {
        switch (adEvent) {
    ...
    private MyPublisherAdViewWrapper createPublisherAdView() {
        return MyPublisherAdViewWrapper.newInstance(applicationContext, gamAdUnitId, this, adSizes);
    }
    ...
    private void primaryAdReceived() {
        ...
        // RequestBanner is null when appEvent was handled before ad was loaded
            ...
            MyPublisherAdViewWrapper gamBannerView = requestBanner;
            requestBanner = null;
    ...
    private View getView(MyPublisherAdViewWrapper gamBannerView) {
